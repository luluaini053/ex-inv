                ...
                <div class="sidebar col-lg-2 collapse d-lg-block" id="navbarTogglerDemo03">
                        @if (Auth::user())
                            @if (Auth::user()->role_id == 1)
                                ...
                                <a href="/departement" @if(request()->route()->uri == 'departement' || request()->route()->uri == 'depart-add' || request()->route()->uri == 'depart-delete/{slug}' || request()->route()->uri == 'depart-deleted' || request()->route()->uri == 'depart-edit/{slug}') class='active' @endif>Departement</a>
